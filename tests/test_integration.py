...
def test_pth_sample4():
    ...
    output = subprocess.check_output(
        [
            sys.executable,
            os.path.join(os.path.dirname(__file__), 'sample4.py'),
        ],
        env=env,
        stderr=subprocess.STDOUT,
    )
...
def test_pth_sample2(LineMatcher):
    ...
    output = subprocess.check_output(
        [
            sys.executable,
            os.path.join(os.path.dirname(__file__), 'sample2.py'),
        ],
        env=env,
        stderr=subprocess.STDOUT,
    )
...
def test_depth_limit_subprocess(LineMatcher, depth):
    ...
    output = subprocess.check_output(
        [
            sys.executable,
            os.path.join(os.path.dirname(__file__), 'sample7.py'),
        ],
...
def test_backlog_subprocess(LineMatcher):
    output = subprocess.check_output(
        [
            sys.executable,
            os.path.join(os.path.dirname(__file__), 'sample7args.py'),
        ],
        stderr=subprocess.STDOUT,
